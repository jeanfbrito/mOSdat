...
date: "2026-05-23"
project: mosdat
topic: Root cause A (8 scenarios):** Windows UIA `_invoke_action` fails on the Fuselage `&lt;ToggleSwitch&gt;` (check box
kind: war-story
scope: project-shared
confidence: medium
---

| tel-qa-013 | FAIL | step 18 — wait_for server combo/label timeout |
| tel-qa-014 | FAIL | step 31 — wait_for dialog/button timeout |
